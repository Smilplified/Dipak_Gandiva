...
import { loadQatlCampaignsForDateRange } from "@/lib/qatl-campaigns-data";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const { campaigns, summary, lead_types, pagination } = await loadQatlCampaignsForDateRange(
      admin,
      orgId,
      range.startUtc,
      range.endUtc,
    ...
    console.error("QATL campaigns list error:", err);
